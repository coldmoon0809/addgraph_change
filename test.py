...
Net1 = ConvGRU(input_channels=args.snapshots_,hidden_channels=args.hidden,kernel_size=(3,3),stride=(1,1),padding=(1,1), dropout=args.dropout)
...
print('===> Loding models...')
dir_ = '/home/wasn/Addgraph/Digg_U_Addgraph_change/checkpoint/adj.pth'
